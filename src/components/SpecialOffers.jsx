  ...
  return (
    <section className="py-16 bg-yellow-100 text-center">
      ...
      <div className="flex flex-wrap justify-center">
        <div className="special-offers-item mx-2 my-4 max-w-sm sm:max-w-md md:max-w-lg bg-yellow-300 p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105">
          ...
          <button className="mt-4 px-4 sm:px-6 py-2 sm:py-3 bg-yellow-500 hover:bg-yellow-600 text-base sm:text-xl font-semibold rounded-full transition duration-300">
            Order Now
          </button>
        </div>
